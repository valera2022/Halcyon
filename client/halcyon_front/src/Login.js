...
function Login (){
    ...
    return (
     ...
     <div className="h-[800px] w-full bg-gradient-to-r from-amber-500 via-yellow-300 to-pink-500 ... ">
        <div className=" pl-[500px] justify-center  ml-[100px] mr-[800px] mt-8 w-40 h-60  ">
          <div className="absolute border  border-indigo-600 mt-10 w-[160px] h-[300px] shadow-xl ">
        ...
        <br></br>
          ...
          <div className="pl-6 pt-8">
           <button type="submit" className="rounded-md bg-indigo-600 w-[100px]  py-2  text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
          </div>
